...
civilizations1 = ['Авраам Линкольн', 'Александр Македонский', 'Аманиторе', 'Амбиорикс', 'Василий II', 'Виктория (Эпоха империи)', 
                    ...
                    'Сулейман (Кануни)', 'Сундиата Кейта', 'Тамара', 'Теодор Рузвельт (Мужественный)', 'Теодор Рузвельт (Прогрессист)',
                    'Токугава', 'Траян', 'Трибхувана', 'Уилфрид Лорье', 'Феодора', 'Филипп II', 'Фридрих Барбаросса',
                    'Харальд Суровый (Варяг)', 'Харальд Суровый (Конунг)', 'Ходзё Токимунэ', 'Хубилай (Китай)', 'Хубилай (Монголия)',
                    'Чака', 'Чандрагупта', 'Чингисхан', 'Чьеу Тхи Чинь', 'Юлий Цезарь', 'Юнлэ', 'Ядвига']
